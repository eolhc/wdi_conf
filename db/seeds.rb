...
speaker_desc = [
  ...
  "Catherine is a web developer on the web weaving web about web with web.",
  ...
  "James is the top open-source contributor for RSVP and peruses the site constantly, testing for bugs.",
  "Json codes in JavaScript like Shakespeare wrote sonnets. Professional romancer in JavaScript.",
  "Ka is a top stackoverflow contributor and the YouTube personality behind 'KaChingKaChan' where he gives advice on creating side projects that leave you with a tidy sum of side cash.",
  "Leon may or may not be a prevalent darknets drug lord. Maybe. Maybe not. But y'know, maybe.",
  ...
  "Nick is known for his ebay gadget site that grew into one of the biggest eCommerce sites of today: 'NickKnacks'",
  "Paul Morello is the creator of CaffeineScript, like CoffeeScript but with more caffeine. Also makes good coffee.",
  "Paul Williams is the founder of 'HomeBrew'd Beerd', a forum where users compare the length of their beards and the taste of their beer.",
  "Pedro won a hackathon when he was 4 years old, with a beer in one hand and a keyboard in the other.",
  "Sean is a professional poker player and is known for 'pokerOn GO', a platform to verse your favourite pokemon in poker.",
  "Tim is known for his music app 'TuneInTim'.",
  "Chloe is known for creating everything from code to terrible personal profiles.",
  "Kerrie is the founder of the popular dating app for 12-18 year olds, 'PuppyLoveMeUp'."
];
talk_title = [
  ...
  "How to Stay Clean and Test your Parts",
